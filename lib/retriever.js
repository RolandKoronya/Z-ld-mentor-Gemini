// lib/retriever.js
// UPDATED: Now uses Google Gemini for embeddings (removing OpenAI dependency)
...
// ⬇️ UPDATED FUNCTION SIGNATURE AND LOGIC ⬇️
export function createRetriever(kb, { geminiApiKey, embedModel = "text-embedding-004" } = {}) {
